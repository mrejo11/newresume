...
//                     تجربه کاری
//                   </div>
//                   <h3 className="text-2xl font-bold text-slate-800 mb-2">تکنسین تعمیر و نگهداری</h3>
//                   <h4 className="text-lg text-cyan-600 mb-3">بانک کشاورزی ساری</h4>
//                   <p className="text-slate-600 mb-4">
//                     تعمیر و نگهداری تجهیزات الکترونیکی و مکانیکی بانک
//                   </p>
//                   <span className="inline-flex items-center text-slate-500">
//                     <span className="w-2 h-2 bg-cyan-500 rounded-full ml-2"></span>
//                     ۱۴۰۱ تا ۱۴۰۲
